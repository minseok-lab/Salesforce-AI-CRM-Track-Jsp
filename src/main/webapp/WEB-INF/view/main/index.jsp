...
<link href="/helloweb/assets/css/main.css" rel="stylesheet" type="text/css">
<title>Mysite</title>
</head>
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img style="width: 150px" id="profile" src="/helloweb/assets/images/profile.png">
					<h2>안녕하세요.<br> 홍길동의 mysite에 방문하신 것을<br/> 환영합니다.</h2>
					<p>
						...
						<br>
						<br>
						<a href="/helloweb/gb">방명록</a>에 글 남기기
						<br>
					</p>
				</div>
			</div>
