...
<link href="/helloweb/assets/css/user.css" rel="stylesheet" type="text/css">
<title>Mysite</title>
<script src="http://code.jquery.com/jquery-latest.js"></script>
<script>
   $(document).ready(function (){   
     // 아이디체크  url : "api/emailCheck.jsp", "/helloweb6/user",
		...
		<div id="wrapper">
			<div id="content">
				<div id="user">
					...
					<form id="join-form" name="joinForm" method="post" action="/helloweb/user">
